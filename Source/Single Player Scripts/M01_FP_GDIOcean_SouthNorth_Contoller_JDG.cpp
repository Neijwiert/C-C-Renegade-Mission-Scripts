...
#include "General.h"
#include "M01_FP_GDIOcean_SouthNorth_Contoller_JDG.h"

/*
M01 -> 101792
*/
void M01_FP_GDIOcean_SouthNorth_Contoller_JDG::Register_Auto_Save_Variables()
{
	Auto_Save_Variable(&this->cinematicFileIndex, sizeof(this->cinematicFileIndex), 1);
}

void M01_FP_GDIOcean_SouthNorth_Contoller_JDG::Created(GameObject *obj)
{
...
void M01_FP_GDIOcean_SouthNorth_Contoller_JDG::Timer_Expired(GameObject *obj, int number)
{
	static const char *flyoverCinematicFiles[26] =
	{
	...
	int randomIndex = Commands->Get_Random_Int(0, 26);
	while (randomIndex == this->cinematicFileIndex)
	{
		randomIndex = Commands->Get_Random_Int(0, 26);
	}
...
ScriptRegistrant<M01_FP_GDIOcean_SouthNorth_Contoller_JDG> M01_FP_GDIOcean_SouthNorth_Contoller_JDGRegistrant("M01_FP_GDIOcean_SouthNorth_Contoller_JDG", "");