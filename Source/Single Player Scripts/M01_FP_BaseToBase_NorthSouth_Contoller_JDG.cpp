...
#include "General.h"
#include "M01_FP_BaseToBase_NorthSouth_Contoller_JDG.h"

void M01_FP_BaseToBase_NorthSouth_Contoller_JDG::Register_Auto_Save_Variables()
{
	Auto_Save_Variable(&this->cinematicFileIndex, sizeof(this->cinematicFileIndex), 1);
}

void M01_FP_BaseToBase_NorthSouth_Contoller_JDG::Created(GameObject *obj)
{
...
void M01_FP_BaseToBase_NorthSouth_Contoller_JDG::Timer_Expired(GameObject *obj, int number)
{
...
ScriptRegistrant<M01_FP_BaseToBase_NorthSouth_Contoller_JDG> M01_FP_BaseToBase_NorthSouth_Contoller_JDGRegistrant("M01_FP_BaseToBase_NorthSouth_Contoller_JDG", "");