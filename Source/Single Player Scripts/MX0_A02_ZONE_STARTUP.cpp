...
void MX0_A02_ZONE_STARTUP::Entered(GameObject *obj, GameObject *enterer)
{
	...
	{
		Commands->Send_Custom_Event(obj, MX0A02ControllerObj, 215, 0, 0.0f);

		Commands->Destroy_Object(obj);
	}
}

ScriptRegistrant<MX0_A02_ZONE_STARTUP> MX0_A02_ZONE_STARTUPRegistrant("MX0_A02_ZONE_STARTUP", "");