...
#include "General.h"
#include "M01_HON_Easy_Spawned_Guy_02_JDG.h"

void M01_HON_Easy_Spawned_Guy_02_JDG::Register_Auto_Save_Variables()
{
...
void M01_HON_Easy_Spawned_Guy_02_JDG::Created(GameObject *obj)
{
	...
	params.Set_Movement(Vector3(-224.418f, 510.944f, 4.006f), 0.8f, 0.05f);

	Commands->Action_Goto(obj, params);
}

void M01_HON_Easy_Spawned_Guy_02_JDG::Killed(GameObject *obj, GameObject *killer)
{
	GameObject *M01MissionControllerObj = Commands->Find_Object(100376);

	if (!this->movingToStar)
	{
		Commands->Send_Custom_Event(obj, M01MissionControllerObj, 0, 209, 0.0f);
	}

	Commands->Send_Custom_Event(obj, M01MissionControllerObj, 0, 207, 0.0f);
}

void M01_HON_Easy_Spawned_Guy_02_JDG::Damaged(GameObject *obj, GameObject *damager, float amount)
{
...
void M01_HON_Easy_Spawned_Guy_02_JDG::Enemy_Seen(GameObject *obj, GameObject *enemy)
{
	Vector3 pos = Commands->Get_Position(obj);
...
void M01_HON_Easy_Spawned_Guy_02_JDG::Action_Complete(GameObject *obj, int action_id, ActionCompleteReason complete_reason)
{
...
ScriptRegistrant<M01_HON_Easy_Spawned_Guy_02_JDG> M01_HON_Easy_Spawned_Guy_02_JDGRegistrant("M01_HON_Easy_Spawned_Guy_02_JDG", "");