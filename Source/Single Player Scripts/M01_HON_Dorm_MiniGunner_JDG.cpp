...
#include "General.h"
#include "M01_HON_Dorm_MiniGunner_JDG.h"

/*
M01 -> 101296
*/
void M01_HON_Dorm_MiniGunner_JDG::Created(GameObject *obj)
{
...
void M01_HON_Dorm_MiniGunner_JDG::Damaged(GameObject *obj, GameObject *damager, float amount)
{
...
// TODO
void M01_HON_Dorm_MiniGunner_JDG::Custom(GameObject *obj, int type, int param, GameObject *sender)
{
	if (obj)
	{
		if (param == 16)
...
// TODO
void M01_HON_Dorm_MiniGunner_JDG::Action_Complete(GameObject *obj, int action_id, ActionCompleteReason complete_reason)
{
...
ScriptRegistrant<M01_HON_Dorm_MiniGunner_JDG> M01_HON_Dorm_MiniGunner_JDGRegistrant("M01_HON_Dorm_MiniGunner_JDG", "");