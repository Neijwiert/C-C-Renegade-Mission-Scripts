...
#include "General.h"
#include "M01_HON_Dorm_FlameGuy_JDG.h"

/*
M01 -> 101299
*/
void M01_HON_Dorm_FlameGuy_JDG::Created(GameObject *obj)
{
...
void M01_HON_Dorm_FlameGuy_JDG::Damaged(GameObject *obj, GameObject *damager, float amount)
{
...
void M01_HON_Dorm_FlameGuy_JDG::Custom(GameObject *obj, int type, int param, GameObject *sender)
{
	if (obj)
	{
...
void M01_HON_Dorm_FlameGuy_JDG::Action_Complete(GameObject *obj, int action_id, ActionCompleteReason complete_reason)
{
...
ScriptRegistrant<M01_HON_Dorm_FlameGuy_JDG> M01_HON_Dorm_FlameGuy_JDGRegistrant("M01_HON_Dorm_FlameGuy_JDG", "");