...
#include "General.h"
#include "M01_GDIBasePOW_Air_Evac_Waypath_JDG.h"

// After 0 cinematic frames in XG_M01_GDIBasePow_EvacAnim.txt
void M01_GDIBasePOW_Air_Evac_Waypath_JDG::Created(GameObject *obj)
{
	...
	{
		Commands->Send_Custom_Event(obj, M01GDIBasePOWEncounter02ControllerJDGObj, 0, 13, 0.0f);
	}
}
...
void M01_GDIBasePOW_Air_Evac_Waypath_JDG::Animation_Complete(GameObject *obj, const char *animation_name)
{
...
ScriptRegistrant<M01_GDIBasePOW_Air_Evac_Waypath_JDG> M01_GDIBasePOW_Air_Evac_Waypath_JDGRegistrant("M01_GDIBasePOW_Air_Evac_Waypath_JDG", "");