...
#include "General.h"
#include "M01_FP_NodBase_EastWest_Contoller_JDG.h"

void M01_FP_NodBase_EastWest_Contoller_JDG::Register_Auto_Save_Variables()
{
	Auto_Save_Variable(&this->cinematicFileIndex, sizeof(this->cinematicFileIndex), 1);
}

// On level start
void M01_FP_NodBase_EastWest_Contoller_JDG::Created(GameObject *obj)
{
...
void M01_FP_NodBase_EastWest_Contoller_JDG::Timer_Expired(GameObject *obj, int number)
{
	static const char *flyoverCinematicFiles[72] =
	{
	...
	int randomIndex = Commands->Get_Random_Int(0, 72);
	while (randomIndex == this->cinematicFileIndex)
	{
		randomIndex = Commands->Get_Random_Int(0, 72);
	}
...
ScriptRegistrant<M01_FP_NodBase_EastWest_Contoller_JDG> M01_FP_NodBase_EastWest_Contoller_JDGRegistrant("M01_FP_NodBase_EastWest_Contoller_JDG", "");