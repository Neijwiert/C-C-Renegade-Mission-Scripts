...
#include "General.h"
#include "M01_HON_Chinook_Spawned_Soldier_04_GDI_JDG.h"
...
void M01_HON_Chinook_Spawned_Soldier_04_GDI_JDG::Action_Complete(GameObject *obj, int action_id, ActionCompleteReason complete_reason)
{
	...
	if (action_id == 38)
	{
		...
		{
			Commands->Send_Custom_Event(obj, M01BuggyNewControllerJDGObj, 0, 28, 0.0f);
		}
	}
}

void M01_HON_Chinook_Spawned_Soldier_04_GDI_JDG::Animation_Complete(GameObject *obj, const char *animation_name)
{
	if (!_stricmp(animation_name, "s_a_human.h_a_troopdrop"))
	{
		ActionParamsStruct params;
		params.Set_Basic(this, 100.0f, 38);
		params.Set_Movement(Vector3(-204.157f, 508.64999f, 4.0170002f), 0.8f, 3.0f);

		Commands->Action_Goto(obj, params);
	}
}

ScriptRegistrant<M01_HON_Chinook_Spawned_Soldier_04_GDI_JDG> M01_HON_Chinook_Spawned_Soldier_04_GDI_JDGRegistrant("M01_HON_Chinook_Spawned_Soldier_04_GDI_JDG", "");