...
#include "General.h"
#include "M01_HON_Dorm_ChemGuy_JDG.h"

/*
M01 -> 101298
*/
void M01_HON_Dorm_ChemGuy_JDG::Created(GameObject *obj)
{
...
void M01_HON_Dorm_ChemGuy_JDG::Damaged(GameObject *obj, GameObject *damager, float amount)
{
...
// TODO
void M01_HON_Dorm_ChemGuy_JDG::Custom(GameObject *obj, int type, int param, GameObject *sender)
{
	if (obj)
	{
...
// TODO
void M01_HON_Dorm_ChemGuy_JDG::Action_Complete(GameObject *obj, int action_id, ActionCompleteReason complete_reason)
{
...
ScriptRegistrant<M01_HON_Dorm_ChemGuy_JDG> M01_HON_Dorm_ChemGuy_JDGRegistrant("M01_HON_Dorm_ChemGuy_JDG", "");