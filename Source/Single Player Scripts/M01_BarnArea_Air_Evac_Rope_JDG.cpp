...
#include "General.h"
#include "M01_BarnArea_Air_Evac_Rope_JDG.h"

// After 0 cinematic frames in XG_M01_BarnArea_EvacAnim.txt
void M01_BarnArea_Air_Evac_Rope_JDG::Created(GameObject *obj)
{
	...
	{
		Commands->Send_Custom_Event(obj, M01BarnAreaEvacMonitorJDGObj, 0, 12, 0.0f);
	}
}
...
void M01_BarnArea_Air_Evac_Rope_JDG::Animation_Complete(GameObject *obj, const char *animation_name)
{
...
ScriptRegistrant<M01_BarnArea_Air_Evac_Rope_JDG> M01_BarnArea_Air_Evac_Rope_JDGRegistrant("M01_BarnArea_Air_Evac_Rope_JDG", "");